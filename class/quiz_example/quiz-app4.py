...
class Quiz:
    ...
    def displayScore(self):
        ...
        tekSoruPuan = 100 / len(self.questions)
        toplamPuan = round(self.score * tekSoruPuan)
        print(f"Toplam {len(self.questions)} sorunun {self.score} tanesini bildiniz.")
        print("Kazandığınız puan:", toplamPuan)

    def displayProgress(self):
        countOfQuestions = len(self.questions)
        questionNumber = self.questionIndex + 1

        print(f"Toplam {countOfQuestions} sorunun {questionNumber}. sorusundasınız.".center(100,'*'))
...
q3 = Question("Dünyaca ünlü piyano sanatçımız hangisidir?",
              ...
              "D")
q4 = Question("Yüzüklerin Efendisi filminde yüzük taşıyıcısı kimdir?",
              ["Gandalf","Frodo","Boromir","Legolas"],
              "B")
q5 = Question("Nuri Bilge Ceylan'ın 2023 yapımı filmi hangisidir?",
              ["İklimler","Ahlat Ağacı","Kış Uykusu","Kuru Otlar Üstüne"],
              "D")
