...
def update_users(f_name,l_name,new_first,new_last):
    with open('csv-operations/csv-files/users.csv') as file:
        csv_reader = csv.reader(file)
        users = list(csv_reader)

    count = 0
    with open('csv-operations/csv-files/users.csv','w') as file:
...
# print(update_users('Tolga','Günal','Seda','Günal'))
...
print(delete_users('Tolga','Günal'))