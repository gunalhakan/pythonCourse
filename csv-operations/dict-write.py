...
# with open("csv-operations/csv-files/products.csv","w") as file:
...
# with open("csv-operations/csv-files/products.csv","a") as file:
#     headers = ["ProductName","Price","IsPublished","Category","Reviews"]
#     csv_writer = DictWriter(file, headers)
#     csv_writer.writerow(
#         {
...
with open("csv-operations/csv-files/new-products.csv","w") as file:
    headers = ["ProductName","Price","IsPublished","Category","Reviews"]
    csv_writer = DictWriter(file, headers)
    csv_writer.writeheader()
    for p in products:
